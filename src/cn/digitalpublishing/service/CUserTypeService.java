...
public interface CUserTypeService {
	...
	public List<BUuRelation> getUuRelationPagingList(Map<String, Object> condition, String sort, Integer pageCount,
	...
	public List<BUrl> getUrlPagingList(Map<String, Object> condition, String sort, Integer pageCount, Integer curpage)
			throws Exception;
