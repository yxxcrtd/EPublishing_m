...
public class CustomServiceImpl extends BaseServiceImpl implements CustomService {
	...
	@Override
	public List<CUserTypeProp> getUserTypePropList(
	...
	@Override
	public void updateAccount(CAccount obj, String id, String[] properties)
			throws Exception {
		try{
	...
	@Override
	public void updateUser(CUser obj, String id, String[] properties)
			throws Exception {
		try{
	...
	@Override
	public List<CAccount> getAccountList(Map<String, Object> condition,
	...
	@Override
	public List<CUser> getUserPagingList(Map<String, Object> condition, String sort,
			Integer pageCount, Integer page) throws Exception {
	...
	@Override
	public List<CAccount> getAccountPagingList(Map<String, Object> condition,
	...
	@Override
	public Integer getAccountCount(Map<String, Object> condition, String sort)
			throws Exception {
		int count=0;
		try {
	...
	@Override
	public List<LLicense> getLicenseList(Map<String, Object> condition,
			String sort) throws Exception {
	...
	@Override
	public List<LLicense> getLicensePagingList(Map<String, Object> condition,
			String sort, Integer pageCount, Integer page) throws Exception {
		List<LLicense> list = null;
		try {
	...
	@Override
	public Integer getLicenseCount(Map<String, Object> condition)
			throws Exception {
		int count=0;
		try {
	...
	@Override
	public Integer getLicenseResourceCount(Map<String, Object> condition)
			throws Exception {
		int count=0;
		try {
	...
	@Override
	public Integer getAllLicenseCount(Map<String, Object> condition, String sort)
			throws Exception {
		int count=0;
		try {
	...
	@Override
	public List<LLicense> getAllLicensePagingList(Map<String, Object> condition,
			String sort, Integer pageCount, Integer page) throws Exception {
		List<LLicense> list = null;
		try {
	...
	@Override
	public List<LLicenseIp> getLicenseIpList(Map<String, Object> condition,
			String sort) throws Exception {
	...
	@Override
	public List<LLicenseIp> getLicenseIpPagingList(Map<String, Object> condition,
			String sort, Integer pageCount, Integer page) throws Exception {
		List<LLicenseIp> list = null;
		try {
	...
	@Override
	public List<CUserAlerts> getCUserAlertsList(Map<String, Object> condition,
			String sort) throws Exception {
	...
	@Override
	public void saveOrUpdateUPRelation(String operType, UPRelation obj)
			throws Exception {
		try {
	...
	public Integer getTrialListCount(Map<String, Object> condition)throws Exception {
		int count=0;
		try {
			count = this.daoFacade.getlLicenseDao().getTrialCount(condition);
		} catch (Exception e) {
			throw new CcsException((e instanceof CcsException) ? e.getMessage()	:"License.info.list.count", e);//获取订阅信息总数失败！
		}
		return count;
