...
public interface ConfigureService {
	 ...
	 * @throws Exception
	 */
	public List<BPublisher> getPublisherPagingList(Map<String, Object> condition, String sort, Integer pageCount,
	 ...
	 * @throws Exception
	 */
	public List<BConfiguration> getConfigurePagingList(Map<String, Object> condition, String sort, int pageCount,
	 ...
	 * @throws Exception
	 */
	public List<MMarkData> getMarkDataPagingList(Map<String, Object> condition, String string, int pageCount,
			int curpage) throws Exception;
