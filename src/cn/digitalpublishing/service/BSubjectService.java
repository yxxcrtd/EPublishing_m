...
public interface BSubjectService {
	 ...
	 * @return
	 */
	public List<PCsRelation> getSubPubPageList(Map<String, Object> condition, String sort, int pageCount, int curpage,
	 ...
	 * @throws Exception
	 */
	public List<PCsRelation> getSubPubList(Map<String, Object> condition, String sort) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<BSubject> getSubColListCount(Map<String, Object> condition, String sort) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<PCsRelation> getTops(Map<String, Object> condition, String sort, int pageCount, int curpage, CUser user,
