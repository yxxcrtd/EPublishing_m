...
public interface CustomService {
	...
	/**
	 * 获取类型属性集合 根据用户类型获取相应的属性集合 类型：1，个人；2，机构
	 * 
	 * @param condition
	 * @param sort
	 * @return
	...
	/**
	 * 获取账户集合 注：gongguanghui 用此方法根据uid获取该账户信息，并通过user查询对应的email信息，提供找回密码功能。
	 * 
	 * @param condition
	 * @param sort
	 * @return
	...
	/**
	 * 获取用户属性集合 注：gongguanghui
	 * 用此方法根据email获取该用户属性信息，并通过user查询对应的email信息，提供找回密码功能。
	 * 
	 * @param condition
	 * @param sort
	 * @return
	...
	/**
	 * 通过类别编码code获取用户类型信息 由于code在表中唯一，所以可以根据code获取对应的用户类型信息
	 * 
	 * @param code
	 * @return
	 * @throws Exception
	 ...
	 * @throws Exception
	 */
	public List<CUser> getUserPagingList(Map<String, Object> condition, String sort, Integer pageCount, Integer page)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<CAccount> getAccountPagingList(Map<String, Object> condition, String sort, Integer pageCount,
	 ...
	 * @throws Exception
	 */
	public List<LLicense> getLicensePagingList(Map<String, Object> condition, String sort, Integer pageCount,
			Integer page) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<LLicense> getAllLicensePagingList(Map<String, Object> condition, String sort, Integer pageCount,
			Integer page) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<LLicenseIp> getLicenseIpPagingList(Map<String, Object> condition, String sort, Integer pageCount,
			Integer page) throws Exception;
	...
	/**
	 * 获取用户订阅提醒集合 1.type-1，查询出版物信息订阅 2.type-2，查询主题学科信息订阅
	 * 
	 * @param condition
	 * @param sort
	 * @return
	...
	/**
	 * 根据subject的treeCode删除订阅提醒信息 订阅一级学科主题时，将已经订阅的下级学科主题先删除，然后进行订阅一级学科主题
	 * 
	 * @param treeCode
	 * @throws Exception
	 */
	 ...
	 * @throws Exception
	 */
	public void AddTrials(Object[] pubs, Object[] users, Integer period, String createBy, Integer accessType,
			String accessName, String accessPassword) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void UpdateTrials(String id, String pubId, String userId, Integer period, Integer accessType,
			String accessName, String accessPassword) throws Exception;
	 ...
	 * @throws Exception
	 */
	List<LLicense> getLicensePagingListForIndex(Map<String, Object> condition, String sort, Integer pageCount,
			Integer page) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<LLicense> getCanReadLicensePagingList(Map<String, Object> condition, String sort, Integer pageCount,
			Integer page) throws Exception;

	public List<LLicense> getCartPagingListDown(Map<String, Object> condition, String sort, Integer pageCount,
			Integer page) throws Exception;
