...
public interface CUserService {
	 ...
	 * @throws Exception
	 */
	public List<CFavourites> getFavoutitesPagingList(Map<String, Object> condition, String sort, int pageCount,
	 ...
	 * @throws Exception
	 */
	public List<CDirectory> getDirtoryPagingList(Map<String, Object> condition, String string, int pageCount,
			int curpage) throws Exception;
