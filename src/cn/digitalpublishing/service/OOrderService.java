...
public interface OOrderService {
	 ...
	 * @throws Exception
	 */
	public List<OOrderDetail> getOrderDetailPagingList(Map<String, Object> condition, String sort, int pageCount,
	 ...
	 * @throws Exception
	 */
	public List<OOrder> getOrderPagingList(Map<String, Object> condition, String string, int pageCount, int curpage)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	public String insertOrderWithDetails(HttpServletRequest request, List<OOrderDetail> list, CUser user, String ip,
			Integer payType) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<OTransation> getTransationLogPagingList(Map<String, Object> condition, int pageCount, int curpage)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<OOrderDetail> getOrderDetailList(Map<String, Object> condition, String sort) throws Exception;
	...
	public void updateLUserAlertsLog(Object obj, String className, Serializable id, String[] properties)
			throws Exception;
