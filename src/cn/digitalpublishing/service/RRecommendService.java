...
public interface RRecommendService {
	 ...
	 * @throws Exception
	 */
	public List<RRecommend> getRecommendPagingList(Map<String, Object> condition, String sort, Integer pageCount,
	 ...
	 * @throws Exception
	 */
	public void insertRecommend(RRecommend recommend, RRecommendDetail detail, Map<String, Object> condition)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<RRecommendDetail> getRecommendDetailPagingList(Map<String, Object> condition, String sort,
