...
//			e.printStackTrace();
	...
	public List<PCsRelation> getSubInfoForCol(Map<String,Object> condition,String sort) throws Exception{
		...
		String hql="from PCsRelation a where exists(select 1 from PCcRelation b where a.publications.id=b.publications.id and b.collection.id='"+condition.get("collectionId")+"') group by a.subject.id";
	    try {
