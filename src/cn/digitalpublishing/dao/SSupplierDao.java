...
public class SSupplierDao extends CommonDao<SSupplier, String> {
	...
	public List<SSupplier> getList(Map<String, Object> condition, String sort) throws Exception {
		...
		String property = " id,institutionid,pubId,title,type,author,isbn,issn,pubName,sdate,year,month,platform,fullAccess,fullRefused,refusedLicense,refusedConcurrent,search,searchStandard,searchFederal,toc,download ";
		String field = " a.id,a.institutionid,a.pubId,a.title,a.type,a.author,a.isbn,a.issn,a.pubName,a.sdate,a.year,a.month,a.platform,a.fullAccess,a.fullRefused,a.refusedLicense,a.refusedConcurrent,a.search,a.searchStandard,a.searchFederal,a.toc,a.download ";
		try {
