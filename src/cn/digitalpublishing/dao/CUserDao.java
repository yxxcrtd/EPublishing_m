...
public class CUserDao extends CommonDao<CUser, String> {
	...
	public List<CUser> getList(Map<String, Object> condition, String sort) throws Exception {
		...
		String property = "id,name,userType.id,userType.name,userType.code,institution.id,institution.name,status,createdby,createdon,updatedby,updatedon,institution.logo,institution.logoUrl,institution.logoNote,level,sendStatus, institution.status";
		String field = "a.id,a.name,b.id,b.name,b.code,c.id,c.name,a.status,a.createdby,a.createdon,a.updatedby,a.updatedon,c.logo,c.logoUrl,c.logoNote,a.level,a.sendStatus, c.status";
		try {
