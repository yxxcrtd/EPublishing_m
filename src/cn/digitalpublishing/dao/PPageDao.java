...
public class PPageDao extends CommonDao<PPage, String> {
	...
	public List<PPage> getList(Map<String,Object> condition,String sort)throws Exception{
		...
		String property="id,png,pdf,swf,number,mark,publications.type,publications.publisher.browsePrecent,publications.publisher.downloadPercent,publications.publisher.printPercent,"
		...
		String field="a.id,a.png,a.pdf,a.swf,a.number,a.mark,b.type,pp.browsePrecent,pp.downloadPercent,pp.printPercent,pp.journalBrowse,pp.journalPrint,pp.journalDownload,b.id,b.oa,b.free";
		try{
