...
public class CUserPropDao  extends CommonDao<CUserProp,String>{
	...
	public Integer getCount(Map<String,Object> condition)throws Exception{
		...
		try{
			list=this.hibernateDao.getListByHql("id","cast(count(*) as string)", hql+t.get("where").toString(), ((List<Object>)t.get("condition")).toArray(),"", CUserProp.class.getName());
		}catch(Exception e){
			throw e;
		}
	...
	public List<CUserProp> getList(Map<String,Object> condition,String sort)throws Exception{
		...
		Map<String,Object> t=this.getWhere(condition);
		String property="id,code,key,val,display,svalue,must,user.id,user.name,user.level,userTypeProp.id";
		String field="a.id,a.code,a.key,a.val,a.display,a.svalue,a.must,b.id,b.name,b.level,c.id";
		try{
