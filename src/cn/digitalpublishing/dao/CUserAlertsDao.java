...
public class CUserAlertsDao  extends CommonDao<CUserAlerts,String>{
	...
	public List<CUserAlerts> getList(Map<String,Object> condition,String sort)throws Exception{
		...
		String property="id,frequency,type,treeCode,subject.id,subject.code,subject.name,user.id,user.name";
		String field="a.id,a.frequency,a.type,a.treeCode,b.id,b.code,b.name,c.id,c.name";
		try{
