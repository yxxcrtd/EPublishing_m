		...
		<div class="header">
			<div class="leftHeader">
				<ul>
					...
					<li>
						...
						<img title="搜索" alt="搜索" src="${ctx}/images/search_options_off.png"/>
						</a>
					</li>
					<li>
					...
					<!--
					<li>
						<input name="已订阅" type="checkbox" value="已订阅" checked="checked" style="width: 10px; border: 0; margin-top: 15px; * margin-top: 0px;" />
			...
			<div class="rightHeader">
				<ul>
					...
					<li>
						<a href="javascript:void(0)">中图分类法</a> |
					</li>
					<li>
						<a href="${ctx}/pages/publishers/form/list">出版社</a> |
					</li>
					<li>
						<a href="javascript:void(0)">打包集</a>
					</li>
				</ul>
			</div>
			<div class="clear"></div>
		...
		<div class="mainContainer">
			...
			<div class="borderContainer">
				...
				<div class="leftContainer">
					...
					<div class="publications">
						...
						<span class="fc">点击 开启 发现
							<div class="clearit"></div> Dawson公司电子图书资源全面登陆中图书苑</span>
					</div>
				...
				<div class="rightContainer">
					...
					<div class="clear"></div>
					<div id="signoutlinkdiv" style="display:none;">
						<a id="signoutlink" onclick="loginout()" title="" href="javascript:void(0)">退出</a>
						<a id="signinlink" onclick="$('#loginbox').show()" title="" href="javascript:void(0)">额外账号登录</a>
					</div>			
					<div id ="loginbox" class="formInput">
						<input id="uid" type="text" name="value1"/>
						<div class="clearit"></div>
						<input id="pwd" type="password" name="value1"/>
						<div class="clearit"></div>
						<ul>
							<li>
								<a href="${ctx}/pages/user/form/findPwd">忘记密码?</a>
							</li>
							<li>
								<span>记住账号?</span>
								<input name="取消" type="checkbox" value="取消" />
								<a href="javascript:void(0)" onclick="$('#uid').val('');$('#pwd').val('')">取消</a>
							</li>
						</ul>
						<div class="clearit"></div>
						<div class="button">
					...
					<div id="management" class="box">
						<div class="boxInner">
							<p>账号管理</p>
							<div><a href="/myaccount" title="" >我的账号</a></div>
							<div><a href="/admin" title="" >图书馆管理员</a></div>
							<div><a href="/registration/view" title="" >更新管理员账号信息</a></div>
							<div><a href="/librarian/" title="" >查看MARC数据</a></div>
						</div>
					</div>
					...
					<div id="register" class="box">
						<div class="boxInner">
							...
							<div><a href="${ctx}/pages/user/form/register">注册</a></div>
						</div>
					</div>
