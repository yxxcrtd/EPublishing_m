...
<!-- 	            <c:if test="${mid=='JournalEn'}"><p><a href="${ctx}/pages/user/form/accesslogNew?pubtype=2&type=2&access=1&languagetype=2&btn=1" class="perLiA"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.JournalEn.statistical.title"/></a></p></c:if> -->
<!-- 	            <c:if test="${mid!='JournalEn'}"><p><a href="${ctx}/pages/user/form/accesslogNew?pubtype=2&type=2&access=1&languagetype=2&btn=1"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.JournalEn.statistical.title"/></a></p></c:if> -->
	    	</div>
