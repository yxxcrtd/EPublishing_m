...
<h1 class="underH1">最新资源<span class="fr"><a href="${ctx}/mobile/index/advancedSearchSubmit?lcense=1&subFlag=1&newFlag=true" style="float: right; font-size: 0.7em;">more >></a></span></h1>
		...
		<c:set var="free">${p.publications.free!=null&&p.publications.free==2 }</c:set>
				<div class="mb20 fontFam oh">
                    ...
                    <div class="fl wid90">
	                    <p>
	                    <a class="a_title" title="${p.publications.title}" href="${ctx}/mobile/pages/publications/form/article/${p.publications.id}">
