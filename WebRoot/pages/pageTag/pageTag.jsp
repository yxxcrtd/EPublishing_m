...
<c:if test="${tPages>1}">
	<div class="pagelink fr noMargin">
		<span class="number tr"> <!-- 上一页开始--> <a href="javascript:;"
			...
			</c:if> <!-- 下一页结束 --> <span><ingenta-tag:LanguageTag sessionKey="lang" key="Global.Page.Display"/> <select onchange="GO(this)">
					<option>10</option>
					<option
		...
		</span> <span><ingenta-tag:LanguageTag sessionKey="lang" key="Global.Page.Items"/> <ingenta-tag:LanguageTag sessionKey="lang" key="Global.Page.Total"/> ${form.count } <ingenta-tag:LanguageTag sessionKey="lang" key="Global.Page.Item"/></span>
