...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function dividePage(targetPage){
			...
			document.formList.action="${ctx}/pages/user/form/insTranLog?pageCount="+${form.pageCount}+"&curpage="+targetPage;
			document.formList.submit();
		}
		
		function GO(obj){
			document.formList.action="${ctx}/pages/user/form/insTranLog?pageCount="+$(obj).val();
			document.formList.submit();
		}
		</script>
	</head>
	<body>
    	...
    	<jsp:include page="/pages/menu?mid=expense&type=2" flush="true"/>
    	</c:if>
	    <!--左侧菜单结束-->
		    <div class="perRight">
