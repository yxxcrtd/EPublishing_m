...
<link href="${ctx}/css/SimpleCanleder.css" rel="stylesheet" type="text/css" />
	<script type="text/javascript">
		...
		/* function dividePage(targetPage){
			...
			document.getElementById("form").action="${ctx}/pages/user/form/accesslogNew?pageCount="+${form.pageCount}+"&curpage="+targetPage+"&btn="+${tabIndex};
			document.getElementById("form").submit();
		} */
		function dividePage(targetPage){
			if(targetPage<0){return;}
	...
	<div class="main personMain">
		<!--定义 0102 左边内容区域 开始-->
		<jsp:include page="/pages/menu?mid=Plays&type=2" flush="true" />
		<!--定义 0102 左边内容区域 结束-->
