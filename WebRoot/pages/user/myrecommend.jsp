	...
	<div class="main personMain">
		...
		<!--定义 0102 左边内容区域 开始-->
			<div class="perRight">
               ...
               <%--  <li class="Stab<c:if test="${tabIndex==3 }"> StabSeleted</c:if> Ptab" id="but3"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.Cart.Type.EjournalCn"/></li> --%>
                 <li class="Stab<c:if test="${tabIndex==4 }"> StabSeleted</c:if> Ptab" id="but4"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.Cart.Type.EjournalEn"/></li>
