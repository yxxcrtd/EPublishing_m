...
<script type="text/javascript">
	function toTrialList(){
		window.location.href="${ctx}/mobile/pages/index/trialList";
	};
</script>
<h1 class="underH1">
             <ingenta-tag:LanguageTag key="Global.Label.TrialPub" sessionKey="lang"/>
             <a href="javascript:;" onclick="toTrialList()" style="float: right; font-size: 0.7em;">more >></a>
        </h1>
