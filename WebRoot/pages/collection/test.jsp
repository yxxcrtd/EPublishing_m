	...
	<div class="main">
		<div class="prod fontFam">
			<div class="fl w850">
				...
				<p>
					<span class="mr10">
					<ingenta-tag:LanguageTag key='Page.Publications.Collection.Chinese' sessionKey='lang'/>：${cnBookCount }</span> 
					<span class="mr10"><ingenta-tag:LanguageTag key='Page.Publications.Collection.Forgin' sessionKey='lang'/>：${enBookCount }</span>
					<span class="mr10"><ingenta-tag:LanguageTag key='Page.Collection.Lable.Ejournal' sessionKey='lang'/>：${magazineCount }</span>
					<span class="mr10"><ingenta-tag:LanguageTag key='Page.Index.Search.Lable.Finded4.Option7' sessionKey='lang'/>：${type7 }</span>
				</p>
				<p>
		...
		<c:if test="${form.inLicense}">
			...
			<div class="leftClassity">
				...
				<c:if test="${bookCount>0 }">
					<li class="oh">
					<span class="fl">
					<a href="javascript:void(0)" onclick="changeList('2','1')" class="ico_book">
					<ingenta-tag:LanguageTag key='Pages.User.Subscription.book' sessionKey='lang'/></a>
					</span> 
					<span class="fr"><a href="javascript:void(0)" onclick="changeList('2','1')">[${bookCount}]</a></span>
					</li>
				</c:if>
				<c:if test="${magazineCount>0 }">
					<li class="oh">
					<span class="fl">
					<a href="javascript:void(0)"  onclick="changeList('2','2')" class="ico_jour">
					<ingenta-tag:LanguageTag key='Pages.Index.Lable.Journal' sessionKey='lang'/></a>
					</span> 
					<span class="fr"><a href="javascript:void(0)" onclick="changeList('2','2')">[${magazineCount }]</a></span>
					</li>
			    </c:if>
			    <c:if test="${articleCount>0 }">
			    					<li class="oh">
					<span class="fl">
					<a href="javascript:void(0)" onclick="changeList('2','4')" class="ico_capt">
					<ingenta-tag:LanguageTag key='Pages.Index.Lable.Article' sessionKey='lang'/></a>
					</span> 
					<span class="fr"><a href="javascript:void(0)" onclick="changeList('2','4')">[${articleCount }]</a></span>
					</li>
			    </c:if>
			    <c:if test="${type7>0 }">
			    					<li class="oh">
					<span class="fl">
					<a href="javascript:void(0)" onclick="changeList('2','7')" class="ico_jour">
					<ingenta-tag:LanguageTag key='Page.Index.Search.Lable.Finded4.Option7' sessionKey='lang'/></a>
					</span> 
					<span class="fr"><a href="javascript:void(0)" onclick="changeList('2','7')">[${type7 }]</a></span>
					</li>
			    </c:if>
				</ul>
			</div>
			<div class="leftClassity">
				...
				<ul>
				    <c:if test="${cnCount>0}">
					<li class="oh"><span class="fl">
					<a href="javascript:void(0)" onclick="changeList('3','CHS')" class="ico_nomal">CHS</a></span> <span class="fr"><a href="javascript:void(0)" onclick="changeList('3','CHS')">[${cnCount }]</a></span>
					</li>
					</c:if>
					<c:if test="${enCount>0}">
					<li class="oh"><span class="fl">
					<a href="javascript:void(0)" class="ico_nomal" onclick="changeList('3','EN')">ENG</a></span> <span class="fr"><a href="javascript:void(0)" onclick="changeList('3','EN')">[${enCount }]</a></span>
					</li>
					</c:if>
				</ul>
			</div>
