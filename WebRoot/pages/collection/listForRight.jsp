				...
				<!-- 锁头小图标 -->
					...
					<div class="fl w700">
						...
						<p>
							...
							<c:if test="${favourite}">
							<span><a style="cursor:auto" class="blank" ><img title="已收藏" src="/EPublishing/images/ico/ico13-blank.png" class="vm" />
                            <ingenta-tag:LanguageTag key="Page.Index.Search.Button.Favourite" sessionKey="lang" /></a></span>
							</c:if>
							<c:if test="${!favourite }">
							<span id="${p.publications.id }"><a href="javascript:void(0)" onclick="addFavourites('${p.publications.id}');"><img src="${ctx }/images/ico/ico13-blue.png" class="vm" />
                            <ingenta-tag:LanguageTag key="Page.Index.Search.Button.Favourite" sessionKey="lang" /></a></span>
							</c:if>
