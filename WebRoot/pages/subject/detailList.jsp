		...
		$("a[name='sort']").click(function(){
			 ...
			 if(param=="#"){
				 ...
				 if(url.lastIndexOf("?")==-1){
				 	url += "?order="+param+"&r_="+new Date().getTime();
				 }else{
				 	url += "&order="+param+"&r_="+new Date().getTime();
				 }
...
<script type="text/javascript">
	...
	//弹出层调用
	function popTips(pid, title, code, type, subName) {
		//先将信息放到对应的标签上
...
<!--弹出层样式 结束  -->
	...
	<body>
      ...
      <div class="leftContainer">
        <div class="listTitle">${subjectCode}&nbsp;&nbsp;${p.code }&nbsp;&nbsp;<c:if test="${sessionScope.lang=='zh_CN' }">${subName}</c:if><c:if test="${sessionScope.lang=='en_US' }">${subNameEn }</c:if></div>
        ...
        <div class="subClass">
        	...
        	<p><ingenta-tag:LanguageTag sessionKey="lang" key="Page.Publications.License.Lable"/></p>
          	<div class="clear"></div>
	          <ul>
	          	<li><a <c:if test="${sessionScope.selectType!=null&&sessionScope.selectType=='' }">style="color:#ee8200;"</c:if> href="${ctx }/pages/subject/form/list?pCode=${pCode}&type=${type}&code=${treeCode}&pubYear=${pubYear}&publisherId=${publisherid}&order=${order}&isLicense=&r_=${r_}"><ingenta-tag:LanguageTag sessionKey="lang" key="Global.Page.Select.All"/></a></li>
	          	<li><a <c:if test="${sessionScope.selectType==null||sessionScope.selectType==1 }">style="color:#ee8200;"</c:if> href="${ctx }/pages/subject/form/list?pCode=${pCode}&type=${type}&code=${treeCode}&pubYear=${pubYear}&publisherId=${publisherid}&order=${order}&isLicense=1&r_=${r_}"><ingenta-tag:LanguageTag sessionKey="lang" key="Global.Button.license"/></a></li>
	          </ul>
          	<div class="clear"></div>
          	</c:if>
         ...
         <p><ingenta-tag:LanguageTag key="Page.Publications.DetailList.Lable.Sub" sessionKey="lang" />：</p>
          <div class="clear"></div>
          <ul id="subject_statistic" style="text-align: center;">
          ...
          <div class="clear"></div>
          <ul id="type_statistic" style="text-align: center;">
          	<img src="${ctx}/images/loading.gif"/>
          </ul>
          ...
          <div class="clear"></div>
          <ul id="year_statistic" style="text-align: center;">
			<img src="${ctx}/images/loading.gif"/>
          </ul>
          <div class="clear"></div>
          <p><ingenta-tag:LanguageTag key="Page.Index.Search.Lable.Filter.Publisher" sessionKey="lang" />：</p>
          <div class="clear"></div>
          <ul id="publisher_statistic" style="text-align: center;">
          	<img src="${ctx}/images/loading.gif"/>
          </ul>
        ...
        <div class="resultsContainer">
          <div class="resultsnav">
            ...
            <div class="clear"></div>
            <div class="a_to_z">
                <a name="sort" id="ALL" href="javascript:void(0);" >#</a>
                <a name="sort" id="A" href="javascript:void(0);" >A</a>
                <a name="sort" id="B" href="javascript:void(0);" >B</a>
                <a name="sort" id="C" href="javascript:void(0);" >C</a>
                <a name="sort" id="D" href="javascript:void(0);" >D</a>
                <a name="sort" id="E" href="javascript:void(0);" >E</a>
                <a name="sort" id="F" href="javascript:void(0);" >F</a>
                <a name="sort" id="G" href="javascript:void(0);" >G</a>
                <a name="sort" id="H" href="javascript:void(0);" >H</a>
                <a name="sort" id="I" href="javascript:void(0);" >I</a>
                <a name="sort" id="J" href="javascript:void(0);" >J</a>
                <a name="sort" id="K" href="javascript:void(0);" >K</a>
                <a name="sort" id="L" href="javascript:void(0);" >L</a>
                <a name="sort" id="M" href="javascript:void(0);" >M</a>
                <a name="sort" id="N" href="javascript:void(0);" >N</a>
                <a name="sort" id="O" href="javascript:void(0);" >O</a>
                <a name="sort" id="P" href="javascript:void(0);" >P</a>
                <a name="sort" id="Q" href="javascript:void(0);" >Q</a>
                <a name="sort" id="R" href="javascript:void(0);" >R</a>
                <a name="sort" id="S" href="javascript:void(0);" >S</a>
                <a name="sort" id="T" href="javascript:void(0);" >T</a>
                <a name="sort" id="U" href="javascript:void(0);" >U</a>
                <a name="sort" id="V" href="javascript:void(0);" >V</a>
                <a name="sort" id="W" href="javascript:void(0);" >W</a>
                <a name="sort" id="X" href="javascript:void(0);" >X</a>
                <a name="sort" id="Y" href="javascript:void(0);" >Y</a>
                <a name="sort" id="Z" href="javascript:void(0);" >Z</a>
                </div>
                <div class="clear"></div>
          </div>
          <div class="clear"></div>
