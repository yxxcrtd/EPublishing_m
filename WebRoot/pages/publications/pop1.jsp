...
<c:if test="${pageCode == 'p1'}">
    <div class="addContDiv" align="center" style="position: relative;top:50px;">
        ...
        <p class="mt30">
        	<span class="mr5">
        		<a href="javascript:void(0)" class="ico ico_reading" style="color: white; font: -webkit-small-control; font-size: inherit;" onclick="viewPopTips('${readPubId}','${readPubStartPage}')"><ingenta-tag:LanguageTag sessionKey="lang" key="Page.Publications.Lable.Read" /></a>
        	</span>
			<span class="mr5">
				<a href="javascript:;" class="ico ico_download"  style="color: white; font: -webkit-small-control; font-size: inherit;" onclick="down();"><ingenta-tag:LanguageTag sessionKey="lang" key="Global.Button.DownLoad"/></a>
			</span>
        </p>
    </div>
</c:if>
    ...
    <div class="addContDiv" align="center" style="position: relative;top:50px;">
        <p><ingenta-tag:LanguageTag sessionKey="lang" key="Page.Publications.Lable.Pop2"/></p>
         <p class="mt30"><span class="mr5"><a href="javascript:void(0)" class="ico ico_reading" style="color: white; font: -webkit-small-control; font-size: inherit;" onclick="viewPopTips('${readPubId}','${readPubStartPage}')"><ingenta-tag:LanguageTag sessionKey="lang" key="Page.Publications.Lable.Read" /></a></span></p>
    </div>
    </c:if>
