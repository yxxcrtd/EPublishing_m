       ...
       <!--  您未购买此资源，是否要将此资源加入到购物车中 -->
        ...
        <c:if test="${pageCode=p1} ">           
         <p><ingenta-tag:LanguageTag key="Page.Publications.Lable.Pop2" sessionKey="lang"/></p>
          <p class="mt30"><span class="mr5"><a href="javascript:void(0)" class="ico ico_reading" style="color: white; font: -webkit-small-control; font-size: inherit;"><ingenta-tag:LanguageTag key="Global.Button.DownLoad.Page" sessionKey="lang"/></a></span> <span class="mr5">
          <a href="javascript:void(0)" class="ico ico_download"  style="color: white; font: -webkit-small-control; font-size: inherit;"><ingenta-tag:LanguageTag key="Global.Button.DownLoad" sessionKey="lang"/></a></span>
        </c:if>
