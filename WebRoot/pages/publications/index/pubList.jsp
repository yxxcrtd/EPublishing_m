                            ...
                            <div class="oh">
                                ...
                                <div class="bookBlock">
                               	 <a href="${ctx}/pages/publications/form/article/${p.id}">
                                     <img src="${ctx}/pages/publications/form/cover?t=1&id=${p.id}" width="95" height="130" onerror="this.src='${ctx}/images/noimg.jpg'" class="mr10 imgbor"/> 
                                 </a>
                 ...
                 <%--          <c:if test="${p.publications.cover==null||p.publications.cover=='' }">
						...
						<c:if test="${p.publications.cover!=null&&p.publications.cover!='' }">
							<img onload="AutoResizeImage(130,95,this);" src="${ctx}/pages/publications/form/cover?t=1&id=${p.publications.id}" style="width:1px;height:1px;float:right; margin-top:5px; margin-right:2px;"class="mr10 imgbor"/>
                                     ...
                                     <p class="bookTit"> <a class="a_title" title="${index.index}${p.title}"
